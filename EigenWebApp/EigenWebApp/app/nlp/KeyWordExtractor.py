...
class KeyWordExtractor(object):
    ...
    def get_highest_word_count(self, document_number, processed_text_documents):
        word_count_vector = self.count_vectorizer.fit_transform(processed_text_documents)
        sorted_items = self.sort_coo(word_count_vector[document_number].tocoo())
